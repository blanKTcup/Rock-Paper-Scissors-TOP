...
function playGame() {
	...
	if (playerScore > computerScore) {
		resultsEL.textContent =
			'The game is over...Luckily, you won the game! Thanks for Playing!';
	} else if (computerScore > playerScore) {
		resultsEL.textContent =
			'The game is over...Unfortunately, you lost the game :( Thanks for Playing!';
	} else {
		resultsEL.textContent =
			'The game is over...Surprisingly, this game is a tie! Thanks for Playing!';
	}
}
